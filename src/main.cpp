...
// - Add LICENSE file - Choose MIT or similar, add LICENSE to repo root, update README.
...
// - #include ordering in settings.h - Move #include <unordered_map> and #include <vector> to the top of the file.
